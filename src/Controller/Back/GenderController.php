...
{
    #[Route('/', name: 'app_back_gender_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_back_gender_new', methods: ['GET', 'POST'])]
    public function new(Request $request, GenderRepository $genderRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_gender_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_back_gender_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_back_gender_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_back_gender_delete', methods: ['POST'])]
